    ...
    <header className="bg-gray-800 text-white shadow-md">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div className="text-2xl font-bold">
          <Link href="/">Netflix</Link> {/* Home link */}
        </div>
        ...
        <nav className="hidden md:flex space-x-6">
          ...
          <Link href="/toprated" className="hover:text-gray-400">
            Top Rated
          </Link>
        ...
        <div className="hidden md:flex items-center">
          <form onSubmit={handleSearch} className="flex items-center">
            ...
            <button
              type="submit"
              className="px-4 py-2 bg-gray-700 rounded-r-md hover:bg-gray-600"
            >
              Search
            </button>
          </form>
      ...
      {isOpen && (
        <nav className="md:hidden bg-gray-800">
          ...
          <Link href="/toprated" className="block px-4 py-2 hover:bg-gray-700">
            Top Rated
          </Link>
          <Link href="/upcoming" className="block px-4 py-2 hover:bg-gray-700">
            Upcoming
          </Link>
